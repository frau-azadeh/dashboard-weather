import { WiDayWindy , WiDayLightning ,WiThermometer, WiBarometer} from "react-icons/wi";
    ...
    <>
      <div className="flex min-h-screen">
        ...
        <div className= "mini mt-20 flex flex-col space-y-2 w-full h-[calc(100vh)]">
            <div className= " hover:ml-4 justify-end pr-2 text-white hover:text-purple-500 dark:hover:text-blue-500  bg-[#1E293B] p-3 rounded-full transform ease-in-out duration-300 flex">
                <WiDayLightning  size={30}/>                                
            </div>
            <div className= "hover:ml-4 justify-end pr-2 text-white hover:text-purple-500 dark:hover:text-blue-500 w-full bg-[#1E293B] p-3 rounded-full transform ease-in-out duration-300 flex">
                <GiWorld size={30}/>              
            </div>
            <div className= "hover:ml-4 justify-end pr-2 text-white hover:text-purple-500 dark:hover:text-blue-500 w-full bg-[#1E293B] p-3 rounded-full transform ease-in-out duration-300 flex">
