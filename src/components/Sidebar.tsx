import { WiGaleWarning, WiDayLightning } from "react-icons/wi";
...
<aside className = "w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B] ">
   ...
   <div className= "mini mt-20 flex flex-col space-y-2 w-full h-[calc(100vh)]">
       <div className= "w-50 h-35 hover:ml-4 justify-end pr-5 text-white hover:text-purple-500 dark:hover:text-blue-500  bg-[#1E293B] p-3 rounded-full transform ease-in-out duration-300 flex">
       <WiDayLightning />                                
       </div>
